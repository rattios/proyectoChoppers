...
export class Ver_sucursalComponent {
  ...
  @ViewChild('editSucursalModal') public lgModal: ModalDirective;
  ...
  initSucursales(){
    ...
    .then(
      data => {
        ...
        this.sucursales.sort(function(a, b){
  ...
  editSucursal(sucursal){
    ...
    this.registerSucursalForm.patchValue({telefono: sucursal.telefono });
    ...
    this.registerSucursalForm.patchValue({sucursal_id: sucursal.id });
    this.url = sucursal.logo;
    this.page();
    this.images = JSON.parse(sucursal.imagenes);
    this.latitude = parseFloat(sucursal.lat);
    this.longitude = parseFloat(sucursal.lng);
    this.zoom = 18;
    this.lgModal.show();
  }
  ...
  updateCompany(){
    ...
    if (this.registerSucursalForm.valid) {
      ...
      this.http.put(this.ruta.get_ruta()+'sucursales/'+this.registerSucursalForm.value.sucursal_id, this.registerSucursalForm.value)
      .toPromise()
      .then(
      data => {
        ...
        this.toastr.success('Sucursal editada con éxito', 'Éxito', {
          timeOut: 5000
        });
      },
      msg => { 
  ...
  deleteSucursal(sucursal){
    this.spinnerService.show();
    this.http.delete(this.ruta.get_ruta()+'sucursales/'+sucursal.id)
    .toPromise()
    .then(
    data => {
      this.spinnerService.hide();
      this.initSucursales();
      this.toastr.success('Sucursal eliminada con éxito', 'Éxito', {
        timeOut: 5000
      });
    },
    msg => { 
