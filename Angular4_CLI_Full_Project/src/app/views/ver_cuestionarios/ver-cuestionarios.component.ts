...
export class verCuestionariosComponent {
  ...
  showEdit(cuestionario){
    ...
    if (cuestionario.estado == 'En espera de agregar las preguntas a evaluar') {
      this.create_cuestionario.estado = 0;
    } else if (cuestionario.estado == 'En revisión') {
      this.create_cuestionario.estado = 1;
    } else if (cuestionario.estado == 'Rechazado') {
      this.create_cuestionario.estado = 1;
    } else if (cuestionario.estado == 'Publicado') {
