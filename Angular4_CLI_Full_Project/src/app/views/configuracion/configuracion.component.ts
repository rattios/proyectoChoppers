...
export class ConfiguracionComponent {
  ...
  public url:string = 'http://shopper.internow.com.mx/images/flats.png';
  public datosS:any;
  public sucursal = [];
  formErrors = {
    'nombre': '',
  ...
  constructor(private http: HttpClient, private router: Router, private ruta: RutaService, private mapsAPILoader: MapsAPILoader, private ngZone: NgZone, private builder: FormBuilder, private toastr: ToastrService, private spinnerService: Ng4LoadingSpinnerService, private cdRef:ChangeDetectorRef, private sharedService: SharedService) {
    ...
    this.registerUserForm = this.builder.group({
      ...
      telefono: [''],
      imagen: ['http://shopper.internow.com.mx/images/flats.png']
    });
    this.registerSucursalForm = this.builder.group({
      ...
      Hfin: ['23:00'],
      imagenes: [''],
      logo: ['http://shopper.internow.com.mx/images/flats.png'],
      horario: [''],
      lat: [''],
      lng: [''],
  ...
  clearFile() {
    ...
    this.registerUserForm.patchValue({imagen : 'http://shopper.internow.com.mx/images/flats.png'});
    this.registerSucursalForm.patchValue({logo : 'http://shopper.internow.com.mx/images/flats.png'});
  }
